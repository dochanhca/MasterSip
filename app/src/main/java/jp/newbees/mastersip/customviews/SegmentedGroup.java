...
/**
 * Created by thangit14 on 9/27/16.
 */
public class SegmentedGroup extends RadioGroup {
    ...
    private int mUnCheckedTintColor = Color.WHITE;
    ...
    private HashMap<Object, Object> mDrawableMap;
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray typedArray = getContext().getTheme().obtainStyledAttributes(attrs,
                R.styleable.SegmentedGroup, 0, 0);

        try {
            mMarginDp = (int) typedArray.getDimension(R.styleable.SegmentedGroup_sc_border_width,
    ...
    private void updateBackground(View view) {
        ...
        super.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                TransitionDrawable current = (TransitionDrawable) mDrawableMap.get(checkedId);
                current.reverseTransition(200);
                if (mLastCheckId != 0) {
                    TransitionDrawable last = (TransitionDrawable) mDrawableMap.get(mLastCheckId);
